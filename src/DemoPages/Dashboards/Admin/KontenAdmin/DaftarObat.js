...
export default class DaftarObat extends React.Component {
    ...
    constructor(props) {
        ...
        this.columns = [
            ...
            //         onClick={() => this.deleteObat(daftarObat.idObat)}>Hapus</button>
            //     </Fragment>
            //     );
            //     }
            // }
    ...
    // deleteObat = (idObat) => {
    //     axios.delete("http://localhost:1212/v1/app/obat/"+idObat)
    //     .then(response => {
    //         this.refreshList();
    //         this.refreshListObat();
    ...
    //             this.handleClick();
    //             this.setState({
    //                 daftarObat: this.state.daftarObat.filter(daftarObat=> daftarObat.idObat !== idObat)
    //             })
    //         }
    //     });
    // }
