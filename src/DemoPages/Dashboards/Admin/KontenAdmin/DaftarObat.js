...
export default class DaftarObat extends React.Component {
  ...
  componentDidMount() {
    axios.get("http://localhost:1212/v1/app/obat").then((response) => {
  ...
  findAvailableIdObat = () => {
    axios.get("http://localhost:1212/v1/app/obat/jumlah").then((response) => {
  ...
  render() {
    ...
    const tableData = {
      ...
      data: this.state.daftarObat.map((daftarObat) => ({
        idObat: parseInt(daftarObat.idObat),
          ...
          <Row>
            <Col md="12">
              <div className="card mb-3 widget-chart">
                ...
                <div className="widget-subheading">Jumlah Jenis Obat</div>
              </div>
            </Col>
          </Row>
          <Row>
